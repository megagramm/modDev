...
Доступные опции:
	-d | --device   [обязательная] hostname или ip устройства. Также можно указать путь к файлу, где каждое устройство записано на новой строке.
	-c | --command  [обязательная] команда на исполение. Также можно указать путь к файлу, где каждая команда указана на новой строке
